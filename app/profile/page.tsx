      ...
      <div className="page">
        <div style={{ background: 'var(--primary)', padding: '24px 16px', display: 'flex', gap: 14, alignItems: 'center' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: 'rgba(255,255,255,.65)', marginBottom: 6 }}>{user.phone}</div>
            <div style={{ display: 'flex', gap: 6 }}>
              <span className="badge" style={{ background: 'rgba(255,255,255,.2)', color: 'white', fontSize: 11 }}>📚 Free Plan</span>
              {user.is_pioneer && <span className="badge" style={{ background: 'rgba(255,255,255,.2)', color: 'white', fontSize: 11 }}>🏆 Pioneer</span>}
            </div>
          </div>
        </div>
